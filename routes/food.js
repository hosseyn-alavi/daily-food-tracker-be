...
// Add food
router.post("/", utils_1.authenticateToken, function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var food, _a;
...
router.get("/", utils_1.authenticateToken, function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var foods, _a;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
...
router.delete("/:id", utils_1.authenticateToken, function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 1:
                _b.trys.push([1, 3, , 4]);
                return [4 /*yield*/, Food_1.Food.destroy({ where: { id: id } })];
            case 2:
                food = _b.sent();
                if (food) {
