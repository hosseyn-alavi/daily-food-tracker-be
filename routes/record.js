...
router.get("/:date", utils_1.authenticateToken, function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var date, records, _a;
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 1:
                _b.trys.push([1, 3, , 4]);
                return [4 /*yield*/, DailyRecord_1.DailyRecord.findAll({
                        where: { date: date, userId: req.user.userId },
                    })];
            case 2:
                records = _b.sent();
                if (records) {
...
router.post("/:date", utils_1.authenticateToken, function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var date, record, _a;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
